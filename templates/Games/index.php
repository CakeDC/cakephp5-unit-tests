        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $game->hasValue('user') ? $this->Html->link($game->user->email, ['controller' => 'Users', 'action' => 'view', $game->user->id]) : '' ?></td>
                    <td><?= h($game->is_player_winner) ?></td>
                    <td><?= $game->hasValue('tournament') ? $this->Html->link($game->tournament->name, ['controller' => 'Tournaments', 'action' => 'view', $game->tournament->id]) : '' ?></td>
                    <td class="actions">
