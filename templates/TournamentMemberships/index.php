 ...
 * @var iterable<\App\Model\Entity\TournamentMembership> $tournamentMemberships
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $tournamentMembership->hasValue('tournament') ? $this->Html->link($tournamentMembership->tournament->name, ['controller' => 'Tournaments', 'action' => 'view', $tournamentMembership->tournament->id]) : '' ?></td>
                    <td><?= $tournamentMembership->hasValue('user') ? $this->Html->link($tournamentMembership->user->email, ['controller' => 'Users', 'action' => 'view', $tournamentMembership->user->id]) : '' ?></td>
