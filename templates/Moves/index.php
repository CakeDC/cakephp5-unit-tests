 ...
 * @var iterable<\App\Model\Entity\Move> $moves
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $move->hasValue('user') ? $this->Html->link($move->user->email, ['controller' => 'Users', 'action' => 'view', $move->user->id]) : '' ?></td>
                    <td><?= $move->hasValue('game') ? $this->Html->link($move->game->id, ['controller' => 'Games', 'action' => 'view', $move->game->id]) : '' ?></td>
